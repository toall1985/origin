...
SOURCES = [{"title": "FREEDOM IPTV", "url": "http://freedomiptv.tk/freedomenter.xml", "fanart": "http://freedomiptv.tk/fanart.jpg", "GENERO": "IPTV ", "date": "09/12/2016", "credits": "MADDOG", "thumbnail": "http://freedomiptv.tk/icon.png"}]
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from Sanctuary Favorites','XBMC.RunPlugin(%s?mode=1906&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(('Add to Sanctuary Favorites','XBMC.RunPlugin(%s?mode=1905&name=%s&url=%s&iconimage=%s&fanart=%s&fav_mode=%s)'
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from Sanctuary Favorites','XBMC.RunPlugin(%s?mode=1906&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
                ...
                contextMenu.append(('Add to Sanctuary Favorites','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)

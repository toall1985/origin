...
elif mode == 1002 	: Xvideos.X_vid_Menu()
elif mode == 1003	: Xvideos.tags(url)
elif mode == 1004	: Xvideos.Pornstars(url)
elif mode == 1005	: Xvideos.New_Videos(url)
elif mode == 1006	: Xvideos.Genres(url)
elif mode == 1007	: Xvideos.Search_X()
elif mode == 1008	: Xvideos.PlayLink(url)

...
search_filenames = ['demosearch1','demosearch2','demosearch3','demosearch4','demo.php','demo1.php','demo2.php'] ### ADD YOUR PHP FILE NAMES IN HERE TO BE INCLUDED IN SEARCHES
########################################################################################

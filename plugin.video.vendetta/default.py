...
ADDON_PATH = xbmc.translatePath('special://home/addons/plugin.video.vendetta/')
USERDATA_PATH = xbmc.translatePath('special://home/userdata/addon_data')
ADDON_DATA = USERDATA_PATH + '/plugin.video.vendetta/'
ICON = ADDON_PATH + 'icon.png'
FANART = ADDON_PATH + 'fanart.jpg'
addon_id = 'plugin.video.vendetta'
...
def m3u8_single(url):
	...
	for name,url2 in match:
		try:
			...
			if name[-1] == ' ':
				name = name[:-1]
			play_url = f4murl+url2.replace('[','').replace(']','')+';name=vendetta'
